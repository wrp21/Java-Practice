...
public class FileIo {
  public static void main(String[] args) throws IOException {
    ...
    FileOutputStream output = new FileOutputStream(("outFileOutputStream.txt")); 
    ...
    FileWriter fw = new FileWriter("outFileWriter.txt");
    for(int i = 0; i<11; i++) {
      String data2 = i+"line.\r\n";
      fw.write(data2);
    }
    ...
    PrintWriter pw = new PrintWriter("outPrintWriter.txt");
    for (int i = 0; i < 11; i++ ) {
      String data3 = i + " line.";
    ...
    FileWriter fw2 = new FileWriter("outPrintWriter.txt", true);
    for (int i = 11; i < 23; i++) {
      String data6 = i + " line";
      fw2.write(data6);
    }
    ...
    PrintWriter pw2 = new PrintWriter(new FileWriter("outPrintWriter.txt", true));
    for (int i = 22; i<33; i++) {
      String data7 = i + " line.";
      pw2.println(data7);
    }
    ...
    FileInputStream input = new FileInputStream("outPrintWriter.txt");
    input.read(b);
    ...
    BufferedReader br = new BufferedReader(new FileReader("outPrintWriter.txt"));
    while(true) {
